...
pub fn speed(start: u32, end: u32, time_elapsed: u32) -> u32 {
    ...
    // Avoid division by zero – return 0 when the elapsed time is zero.
    if time_elapsed == 0 {
        return 0;
    }
    // Compute the absolute distance travelled.
    ...
    // Integer division gives the average speed (distance ÷ time).
